...
"""**Matplotlib change_colour function : Changes a square's colour to black, grey or red**"""
...
def draw_rectangle(chosen_xcoord, chosen_ycoord, colour):
  coord = Point(chosen_xcoord, chosen_ycoord)
...
"""# Matplotlib Display (Basic Test Function)"""
...
def turn_black():
  chosen_square = (input('Choose a square: A-K (no I), 0-9. e.g. A0 ')).upper()
  ...
  rect = patches.Rectangle(((chosen_xcoord, int(chosen_square[1]))), 1, 1, facecolor='k')
